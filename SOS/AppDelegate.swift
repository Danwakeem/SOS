...
//  SOS
//
//  Created by Dan jarvis on 12/8/14.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        //Reload the UIButtons and add annotations to the map if they hit save location in the today extension
        var vc = self.window?.rootViewController
        vc?.viewDidLoad()
    }
